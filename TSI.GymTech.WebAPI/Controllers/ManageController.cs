...
namespace TSI.GymTech.WebAPI.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> ChangePasswordConfirmation(ManageMessageId? message)
        {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model, string returnUrl)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return RedirectToAction("ChangePasswordConfirmation", new { Message = ManageMessageId.ChangePasswordSuccess });
            }
            AddErrors(result);
            return View(model);
        }
